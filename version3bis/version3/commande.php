<?php
    ...
    {
        $_SESSION["reference"]=array(); /*ON CREE UN TABLEAU REFERENCE DE $_SESSION*/
        $_SESSION["quantite"]=array(); /*ON CREE UN TABLEAU QUANTITE DE $_SESSION*/
    }
        ...
        <section>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <?php
                                /*RECUPERE LA DESIGNATION D'UN ARTICLE A PARTIR DE SA REFERENCE*/
                        ...
                        <td>
                            <?php
                                /*RECUPERE LE PRIX D'UN ARTICLE A PARTIR DE SA REFERENCE*/
                                $reponse = $bdd->prepare('SELECT * FROM produit WHERE pdt_ref = ? ');
                                $reponse->execute(array($_SESSION["reference"][$j] ));
                                while ($donnees = $reponse->fetch())
                                {
