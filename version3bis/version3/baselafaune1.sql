...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 03 Mai 2015 à 18:43
...
CREATE TABLE IF NOT EXISTS `commande` (
  ...
  `cde_moment` varchar(20) NOT NULL,
  PRIMARY KEY (`cde_client`,`cde_moment`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `commande` (`cde_client`, `cde_moment`) VALUES
('c0002', '1430590309');
...
CREATE TABLE IF NOT EXISTS `contenir` (
  `cde_client` varchar(5) NOT NULL,
  `cde_moment` varchar(15) NOT NULL,
  `produit` varchar(5) NOT NULL,
  `quantite` int(5) NOT NULL,
  PRIMARY KEY (`cde_client`,`cde_moment`,`produit`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `contenir` (`cde_client`, `cde_moment`, `produit`, `quantite`) VALUES
('c0002', '1430590309', 'F01', 2),
('c0002', '1430590309', 'P01', 1),
('c0002', '1430590309', 'W03', 3);
